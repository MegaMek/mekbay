 ...
 * Author: Drake
 *
 * DEPRECATED! Use formation-blueprints.ts instead, which defines blueprints 
 * with a more flexible structure that can be used to generate both requirements and effects.
 * 
