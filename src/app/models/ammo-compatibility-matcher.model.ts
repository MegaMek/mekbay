 ...
 */
export function matchesAmmoCompatibility(match: AmmoCompatibilityMatch): boolean | null {
...
function atmMunitionForMode(mode: string | undefined) {
  switch (mode) {
    case 'High Explosive':
      return 'M_HIGH_EXPLOSIVE' as const;
    case 'Extended Range':
      return 'M_EXTENDED_RANGE' as const;
    case 'Standard':
    default:
      return 'M_STANDARD' as const;
  }
}
