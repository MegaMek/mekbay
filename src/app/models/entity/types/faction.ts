...
export const FACTION_DATA: Record<FactionCode, FactionDescriptor> = {
  None: { code: 'None', codeIO: 'None', name: 'Unspecified', affiliation: 'None' },
  // ── Inner Sphere ──
...
export const ALL_FACTION_CODES: readonly FactionCode[] = (Object.keys(FACTION_DATA) as FactionCode[]).filter(
  (c) => c !== 'None',
);
